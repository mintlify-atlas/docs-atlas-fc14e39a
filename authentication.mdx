---
title: "Authenticate with the Binance SDK"
sidebarTitle: "Authentication"
description: "Configure HMAC, RSA, or Ed25519 authentication for the Binance SDK. Learn how to create API keys, set permissions, and pass credentials to any REST or WebSocket client."
---
...
All four REST clients accept the same `RestClientOptions` shape:

```typescript
interface RestClientOptions {
  api_key?: string;        // Binance API key
  api_secret?: string;     // HMAC secret, RSA PEM private key, or Ed25519 PEM private key
  recvWindow?: number;     // Max request timestamp window in ms (default: Binance default)
  ...
  demoTrading?: boolean;   // Use demo trading endpoints (default: false)
}
```
