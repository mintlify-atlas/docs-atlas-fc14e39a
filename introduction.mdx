---
title: "Binance Node.js SDK: REST and WebSocket API Clients"
sidebarTitle: "Introduction"
description: "Production-ready Node.js SDK for Binance REST and WebSocket APIs. Covers Spot, Futures, Portfolio Margin, and WebSocket API with TypeScript types included."
---
...
<CardGroup cols={2}>
  ...
  <Card title="Browser bundle support" icon="globe">
