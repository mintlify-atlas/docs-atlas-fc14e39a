---
title: "Using the Binance Node.js SDK in Browser Environments"
sidebarTitle: "Browser Usage"
description: "Run the Binance SDK in a browser via the pre-built UMD bundle or your own webpack pipeline. Understand CORS limits and why API keys must stay server-side."
---
