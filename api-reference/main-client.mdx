...
description: "Complete method reference for MainClient, covering Spot, Margin, Wallet, Convert, Earn, and Sub-accounts. Includes auth requirements and usage examples."
---
