...
description: "Complete reference for CoinMClient (Binance COIN-M Futures), covering market data, orders, positions, and account endpoints for coin-settled contracts."
---
