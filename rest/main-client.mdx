---
title: "MainClient: Spot, Margin & Wallet REST API"
sidebarTitle: "MainClient"
description: "MainClient covers Binance Spot, Cross/Isolated Margin, Wallet, Convert, Earn, Sub-accounts, Auto-Invest, Staking, Mining, and Loans via the REST API."
---
...
| `getMarginAccountDetails(params?)` | `GET sapi/v1/margin/account` | Cross-margin account details |
...
| `submitNewMarginOrder(params)` | `POST sapi/v1/margin/order` | Place a margin order |
| `cancelMarginOrder(params)` | `DELETE sapi/v1/margin/order` | Cancel a margin order |
